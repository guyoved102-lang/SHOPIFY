...
**What I could NOT verify (at the time this stage was written):** whether they hold *registered* trademarks for "SOCK ACADEMY" at UKIPO/EUIPO/USPTO/ILPO, and whether their 18-country footprint includes the US (Guy's primary market). Their catalog is novelty/humor socks — the exact register SockAcademy's constitution bans — so brand *confusion* in the wild may be low; but trademark conflict is decided by mark + goods class, not by tone.

**🔴 UPDATE 06/07/2026 — Guy ran the self-search himself, cross-verified via two independent sources:** UK Intellectual Property Office public register + TMview/WIPO Global Brand DB both confirm `UK00003187452`, mark text "Sock Academy", applicant "Sock Academy Limited", **status Registered**, filed 23/09/2016, registered 23/12/2016, expiring 23/09/2026, **Class 25**, goods "Socks and clothing." This is no longer a same-name-company risk — it is a confirmed, currently-registered trademark in the exact goods class.

A broader TMview "contains" search (5 total hits) also found: a **separate, unrelated entity "Dance Sock Academy Limited"** with registered Class 25 marks for "DANCE SOCK ACADEMY LTD" in New Zealand (IPONZ #1143757) and Australia (IPA #2199084) — different name, lower relevance, but same goods class in two more jurisdictions; plus two clearly irrelevant substring false-positives (a UK Class 41 dance-tuition mark, an Italian Class 41 optical-company logo mark) that can be disregarded.

USPTO wordmark search for "SOCKACADEMY" returned zero live/dead records (no apparent US conflict), and the TMview cross-office search surfaced no EUIPO or USPTO hits either. ILPO (Israel) self-search remained inconclusive (input/filter error, not successfully re-run). This finding has been folded into Q8 of `FABLE5_ATTORNEY_PREP.md` and the attorney packet's Gmail draft.
